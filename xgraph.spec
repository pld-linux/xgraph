...
"XGraph z animacją" jest modyfikacją popularnego programu do robienia
wykresów XGraph, napisanego przez Davida Harrisona z Uniwersytetu w
Berkeley. Można w nim robić animacje zestawów danych, powiększać
kawałki wykresu myszką i numerycznie różniczkować dane na wykresie.
